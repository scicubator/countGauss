...
plt.savefig("tests/clean_gauss.pdf", transparent=True, bbox_inches='tight', pad_inches=0)
...
ax.set_xticklabels(labels, fontsize=45)
plt.ylabel("m/k", fontsize=50)
plt.savefig("tests/clean_countgauss.pdf", transparent=True, bbox_inches='tight', pad_inches=0)
