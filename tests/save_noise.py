...
plt.savefig("tests/noise_gauss.pdf", transparent=True, bbox_inches='tight', pad_inches=0)
...
plt.savefig("tests/noise_countgauss.pdf", transparent=True, bbox_inches='tight', pad_inches=0)
